...
def on_message(client, userdata, msg):
  ...
  if MSG == "0":
    ...
    client.publish("PLATE/", t)
    print("FROM: "+msg.topic+" OP: "+msg.payload.decode('utf-8')+" DO: "+t)
    ...
    try:
      ...
      client.publish("PLATE/", lp_number, qos=1)
      print("FROM: "+msg.topic+" OP: "+msg.payload.decode('utf-8')+" DO: "+lp_number)
      with open(IMAGE_PATH, 'rb') as image_file:
        img_base64 = base64.b64encode(image_file.read())
        client.publish("PLATE/img/", img_base64, qos=1)
